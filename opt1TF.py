...
weekday_data = train_data[train_data['WEEKDAY'] < 5]  # 0-4 represents weekdays (Monday to Friday)
weekend_data = train_data[train_data['WEEKDAY'] >= 5]  # 5-6 represents weekends (Saturday and Sunday)
